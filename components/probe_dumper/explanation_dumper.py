...
class Dump:
    def __init__(self, probe, session_uuid):
        self.id = ExplanationDumper.fix_probe_id(probe.id_)
    ...
    def add_explanation(self, probe: TADProbe, explanation: Explanation):
        self.decisions_presented.append(probe.decisions)
        self.scenario_description = probe.state.unstructured
        self.explanation = explanation
        #self.explanation_components.append(explanation.new_cases)
        #self.explanation_components.append(explanation.minDecision)
        #self.explanation_components.append(explanation.minDistance)
        #self.states.append(probe.state)
        


class ExplanationDumper:
    ...
    def dump(self, probe, explanation, session_uuid):
        ...
        opened_dump = opened_dump if opened_dump is not None else Dump(probe, explanation)
        opened_dump.add_explanation(probe, explanation)
